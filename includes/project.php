...
<div class="container-xxl project py-5">
    <div class="container">
        ...
        $sel = "SELECT * FROM projects ORDER BY pj_id ASC LIMIT 0,1";
        ...
        <div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
            <div class="col-lg-4">
                <div class="nav nav-pills d-flex justify-content-between w-100 h-100 me-4">
                    <?php
                    $i = 1;
                    $sel = "SELECT * FROM projects ORDER BY pj_id ASC";
                    $Q = mysqli_query($con, $sel);
                    while ($project = mysqli_fetch_assoc($Q)) {
                    ?>
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-4 <?= ($project['pj_id'] == 1) ? 'active' : '' ?>" data-bs-toggle="pill" data-bs-target="#tab-pane-<?= $project['pj_id'] ?>" type="button">
            ...
            <div class="col-lg-8">
                <div class="tab-content w-100">
                    ...
                    while ($project = mysqli_fetch_assoc($Q)) {
                    ?>
                        <div class="tab-pane fade show <?= ($project['pj_id'] == 1) ? 'active' : '' ?>" id="tab-pane-<?= $project['pj_id'] ?>">
                            <div class="row g-4">
