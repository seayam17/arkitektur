...
if ($_SESSION['role'] == 1) {
  ...
  if(!empty($_POST)){
    ...
    $insert="INSERT INTO contacts(cons_title,cons_subtitle,cons_address,cons_phone,cons_email,cons_map)VALUES('$cons_title','$cons_subtitle','$cons_address','$cons_phone','$cons_email','$cons_map')";

    if(!empty($cons_title)){
      if(mysqli_query($con,$insert)){
        echo "Contacts information upload success";
      }else{
        echo "Contacts information upload failed";
      }
    }else{
      echo "Please enter contacts title";
    }
  }
?>
  <div class="row">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
              <div class="col-md-8 card_title_part">
                <i class="fab fa-gg-circle"></i>Add Contacts Information
              </div>
          ...
          <div class="card-body">
            <div class="row mb-3">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control form_control" id="" name="cons_title">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-form-label col_form_label">Contact Subtitle:</label>
              <div class="col-sm-7">
                <input type="text" class="form-control form_control" id="" name="cons_subtitle">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-form-label col_form_label">Contact Address:</label>
              <div class="col-sm-7">
                <input type="text" class="form-control form_control" id="" name="cons_address">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-form-label col_form_label">Contact Phone:</label>
              <div class="col-sm-7">
                <input type="text" class="form-control form_control" id="" name="cons_phone">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-form-label col_form_label">Contact Email:</label>
              <div class="col-sm-7">
                <input type="text" class="form-control form_control" id="" name="cons_email">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-form-label col_form_label">Contact Map:</label>
              <div class="col-sm-7">
                <input type="text" class="form-control form_control" id="" name="cons_map">
              </div>
            </div>
          </div>
